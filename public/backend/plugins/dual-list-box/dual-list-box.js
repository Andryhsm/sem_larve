...
(function($) {
    ...
    function createDualListBox(options) {
        ...
        $(options.parentElement).addClass('row').append(
                ...
                '       <select class="unselected ' + options.selectClass + '" style="height: 300px; width: 100%;" multiple></select>' +
                '   </div>' +
                ...
                '       <select class="selected ' + options.selectClass + '" style="height: 300px; width: 100%;" multiple></select>' +
                '   </div>');
    ...
    function createVerticalButtons(copyAllBtn) {
        return '   <div class="col-md-2 center-block" style="margin-top: ' + (copyAllBtn ? '120px' : '170px') +'">' +
