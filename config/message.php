...
return [
	...
	*/
	'admin-user' => [
		...
		'add-error' => 'User not added successfully.',
		'update-success' => 'Your information updated successfully.',
		'update-error' => 'User not updated successfully.',
		'delete-success' => 'User deleted successfully.',
		'password-success' => 'User password changed successfully.',
		'password-error' => 'User password not changed successfully.',
	],
	'reset-password' => [
	...
	'priorities'=>[
		'add-success' => 'Priority added successfully.',
		'add-error' => 'Priority not added successfully.',
		'update-success' => 'Priority updated successfully.',
		'update-error' => 'Priority not updated successfully.',
		'delete-success' => 'Priority deleted successfully.',
		'delete-error' => 'Priority not deleted successfully.',
	],
	'tickets'=>[
		'add-success' => 'Ticket added successfully.',
		'add-error' => 'Ticket not added successfully.',
		'update-success' => 'Ticket updated successfully.',
		'update-error' => 'Ticket not updated successfully.',
		'delete-success' => 'Ticket deleted successfully.',
		'delete-error' => 'Ticket not deleted successfully.',
	],
	'comments'=>[
		'send-success' => 'comment send successfully.',
		'send-error' => 'comment not send successfully.',
	],
