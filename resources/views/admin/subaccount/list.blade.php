            ...
            <div class="clearfix">
                <div class="btn-group inline pull-left">
                    <div class="btn btn-small">
                        <a href="{!! route('subaccount.create') !!}" class="btn btn-block btn-primary">Add New
                            Account</a>
                    </div>
                </div>
            </div>
                            ...
                            @if( $admins->recordsTotal > 0 )
                                @foreach($admins->data as $admin)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group">
                                                <a href="{{ route('subaccount.edit', ['id'=> $admin->admin_id]) }}"
                                                   class="btn btn-default btn-sm" title="Edit"><i
                                                            class="fa fa-fw fa-edit"></i></a>
                                                {!! Form::open(array('url' => route('subaccount.destroy', ['id'=> $admin->admin_id]), 'class' => 'pull-right')) !!}
